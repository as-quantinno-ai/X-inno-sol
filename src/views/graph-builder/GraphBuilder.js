...
import { GetJWT, serviceIp, mulVariatePort } from "views/api-configuration/default";
...
export function GraphBuilder() {
    ...
    const changeChartType = (e) => {
        setIFrameSource(`http://${serviceIp}:${mulVariatePort}${visualizationToolkit[e.target.value]()}`);
    };
